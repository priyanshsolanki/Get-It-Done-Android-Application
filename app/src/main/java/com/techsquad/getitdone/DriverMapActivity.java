...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, RoutingListener  {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    if(map.get("address")!=null){
                        mCustomerDestination.setText(map.get("address").toString());
                    }
    ...
    private void endRide(){
        mRideStatus.setText("Reached Customer Location");
        erasePolylines();
        ...
        if(CustomerMapActivity.mDriverMarker != null){
            CustomerMapActivity.mDriverMarker.remove();
        }
        if (assignedCustomerPickupLocationRefListener != null){
            assignedCustomerPickupLocationRef.removeEventListener(assignedCustomerPickupLocationRefListener);
        }
        ...
        public void onLocationResult(LocationResult locationResult) {
            for(Location location : locationResult.getLocations()){
                if(getApplicationContext()!=null){
                    ...
                    DatabaseReference refWorking = FirebaseDatabase.getInstance().getReference("workersWorking");

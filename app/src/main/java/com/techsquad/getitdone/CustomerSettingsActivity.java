...
public class CustomerSettingsActivity extends AppCompatActivity {
    ...
    private void saveUserInformation() {
        ...
        if(resultUri != null) {
            ...
            final StorageReference storageReference = mStorageRefrence.child("profile_images").child(userID);
            Bitmap bitmap = null;
            try {
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                  ...
                  //  Task<Uri> downloadUrl = taskSnapshot.getMetadata().getReference().getDownloadUrl();
                    mStorageRefrence.child("profile_images").child(userID).getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                        @Override
